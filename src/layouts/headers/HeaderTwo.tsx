            ...
            <header id="navigation" className="header-2">
                <div className="container">
                    <div className="row">
                        ...
                        <div
                            className="col-xl-6 col-lg-6 col-md-6 menu_col justify-content-center d-flex align-self-center">
                            <nav id="main-menu">
                                <NavMenu/>
                            </nav>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 align-self-center text-end">
                            <div className="searchcart">
                                ...
                                <div className="cart-icon">
                                    <a style={{cursor: "pointer"}} onClick={() => setCat(!open)} className="mcart_open"
                                       data-menu="#mini_cart">
                ...
                <div id="mini_cart" className={`cart_drawer ${cat ? 'min_cart_active' : ''}`}>
                    <div className="cart_top">
                        <a style={{cursor: "pointer"}} onClick={() => setCat(false)} className="cart_close"><i
                            className='bx bx-x'></i></a>
              ...
              3
                ...
                <div id="sm_menu_ham" className={`${opneMenu ? "open" : ""}`} onClick={() => setOpneMenu(!opneMenu)}>

                ...
                <div className="container">
                        ...
                        <div className="col-xl-8 wow fadeIn">
                            <div className="scourse_image">
                                ...
                                <a
                                    ...
                                    <svg fillRule="evenodd" clipRule="evenodd" imageRendering="optimizeQuality"
                            ...
                            <div className="scourse_meta">
                                <div className="smeta">
                                    <img src={course?.author?.image} alt="author"/>
                      ...
                      <span className="rev_icons">
                       {Array.from({length: course.rating}).map((_, i) => (
                           <i key={i} className="bx bxs-star"></i>
                            ...
                            <h2 className="scourse-title">                                            {course?.title}
                            </h2>

                            <nav className="cd_tab">
                                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button className="nav-link active" id="nav-overview-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-overview" type="button" role="tab"
                                            aria-controls="nav-overview" aria-selected="true">Overview
                                    </button>
                            ...
                            <div className="tab-content" id="nav-tabContent">
                                ...
                                <div className="tab-pane fade" id="nav-curriculum" role="tabpanel"
                                     aria-labelledby="nav-curriculum-tab" tabIndex={0}>
                                    <div className="cd_curriculum">
                                        <h3>Starting Beginners Level Course</h3>
                                        <ul>
                                            <li><span><a href="#"><i className='bx bx-play-circle'></i> Introduction of Editing</a></span>
                                                <span className="cd_cur_right"><a href="#" className="cbtn">Preview</a>10 Minutes</span>
                                            </li>
                                            <li><span><a href="#"><i className='bx bx-play-circle'></i> Overview of Editing</a></span>
                                                <span className="cd_cur_right"><a href="#" className="cbtn">Preview</a>8 Minutes</span>
                                            </li>
                                            <li><span><a href="#"><i className='bx bx-folder'></i> Basic Editing Technology</a></span>
                                                <span className="cd_cur_right"><a href="#" className="cbtn">Preview</a>7 Minutes</span>
                                            </li>
                                            <li>
                        <span>
                          <i className='bx bx-bulb'></i> Quiz</span>
                                                <span className="cd_cur_right"><a href="#" className="cbtn">Preview</a> 5 Minutes</span>
                                            </li>
                                            <li><span><a href="#"><i className='bx bx-play-circle'></i> Introduction of Editing</a></span>
                                                <span className="cd_cur_right"><a href="#" className="cbtn">Preview</a>10 Minutes</span>
                                            </li>
                                            <li><span><a href="#"><i className='bx bx-bulb'></i> Overview of Editing</a></span>
                                                <span className="cd_cur_right"><a href="#" className="cbtn">Preview</a>30 Minutes</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <textarea name="rating_form" placeholder="Write a Your Rating">
                                ...
                                <div className="tab-pane fade" id="nav-instructor" role="tabpanel"
                                    ...
                                    <div className="cd_instructor">
                                        ...
                                        <div className="cdin_content">
                                            ...
                                            <div className="cdin_meta">
                                                <div className="cdin_meta_item"><i className="bx bx-user"></i> 25+
                                                    Students
                                                </div>
                                                <div className="cdin_meta_item"><i
                                                    className='bx bxs-folder-open'></i> 32 Courses
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <span className="cside-label">
                      <i className="fa-regular fa-clock"></i> Duration
                                        ...
                                        <span
                                            className="cside-value">                                            {course?.duration}
                    </span>
                                    </li>
                      ...
                      English
                                ...
                                <div className="text-center">
                                    <a href="#" className="bg_btn bt">
                                        {
                                            course?.isFree ? 'Boshlash' : 'Sotib olish'
                                        }
                                    </a>
                                </div>
